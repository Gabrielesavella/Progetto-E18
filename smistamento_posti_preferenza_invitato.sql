...
CREATE TABLE `preferenza_invitato` (
  ...
  `VoglioStareVicinoA` varchar(200) DEFAULT NULL,
  `NonVoglioStareVicinoA` varchar(200) DEFAULT NULL,
...
INSERT INTO `preferenza_invitato` VALUES ('Matrimonio Batman-Catwoman','ClaKen038','DiaPri042, HalJor050','ArtCur060');
