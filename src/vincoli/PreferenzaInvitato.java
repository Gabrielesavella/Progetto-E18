...
public class PreferenzaInvitato implements Vincolo {
    ...
    public PreferenzaInvitato(Invitato invitato, ArrayList<Invitato> vincolatiAInvitato, Evento evento, PreferenzaInvitatoEnum preferenza) {
    ...
    public boolean controllaIncongruenze() {
        ...
        for (Vincolo v : evento.getLista_vincoli()){
            ...
            for (int k=0; k<lista_vincolati.size(); k++){
                ...
                if (v instanceof PreferenzaInvitato && !(((PreferenzaInvitato) v).getPreferenza().equals(preferenza)) && ((PreferenzaInvitato) v).getLista_vincolati().contains(lista_vincolati.get(k)) && max_accettabile>0){
